...
- Include browser controls for text scaling (縮小／100%／放大／重設) so users can adjust title and body font sizes without editing CSS; keep the fixed canvas and print dimensions unchanged.
