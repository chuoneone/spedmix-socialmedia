...
- Main text: dark coffee brown, bold, clean Traditional Chinese sans serif. Use one headline family/weight per slide.
- Supporting text: the same family in a smaller regular weight. Keep it dark brown or nearly black.
...
- Use a safe Traditional Chinese font stack: `"Noto Sans TC", "Microsoft JhengHei", sans-serif`.
