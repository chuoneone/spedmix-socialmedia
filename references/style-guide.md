...
- Provide screen-only per-text-block size controls (縮小、100%、放大、重設). Clicking a text block makes it active; controls must not change other text blocks and must preserve the 1080×1350 print canvas.
