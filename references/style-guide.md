...
- Provide screen-only per-slide text-size controls (縮小、100%、放大、重設). Clicking a slide makes it active; controls must not change other slides and must preserve the 1080×1350 print canvas.
